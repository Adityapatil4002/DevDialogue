  ...
  return (
    <main className="min-h-screen bg-[#050505] flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-[#0b0f19] border border-[#1a1f2e] rounded-2xl p-8">
        ...
        {/* ✅ Google Register Button - add this before the form */}
        <button
          onClick={handleGoogleLogin}
          disabled={googleLoading}
          className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl border border-[#1f2533] bg-[#141820] text-white hover:border-gray-600 hover:bg-[#1a1f2e] transition-all mb-6 disabled:opacity-50"
        >
          {googleLoading ? (
