...
const Register = () => {
  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen bg-[#0f131a] text-gray-100 font-sans overflow-hidden selection:bg-cyan-500 selection:text-white">
      ...
      {/* Main Card Container — FIXED: min-h instead of fixed h for multi-step SignUp */}
      <div className="relative w-full max-w-5xl min-h-[650px] m-4 flex rounded-3xl shadow-2xl overflow-hidden border border-gray-800 animate-card-entry">
        ...
        {/* FIXED: reduced padding, added overflow-y-auto for verification steps */}
        <div className="w-full md:w-[55%] bg-[#141820] p-6 md:p-10 flex flex-col justify-center items-center relative z-20 overflow-y-auto">
